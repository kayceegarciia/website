      ...
      >
        <Suspense fallback={null}>
          ...
          <Physics gravity={gravity} timeStep={isMobile ? 1 / 30 : 1 / 60}>
            <Band isMobile={isMobile} windowDimensions={dimensions} />
          </Physics>
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, windowDimensions = { width: 1000, height: 1000 } }: BandProps) {
  ...
  const texture = useTexture('/lanyard/lanyard.png' as any);
    ...
    <>
      ...
      <mesh ref={band}>
        ...
        <meshLineMaterial
          color="white"
          depthTest={false}
          resolution={new THREE.Vector2(windowDimensions.width, windowDimensions.height)}
          useMap
          map={texture}
          repeat={[-4, 1]}
          lineWidth={1}
